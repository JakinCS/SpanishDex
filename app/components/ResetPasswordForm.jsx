    ...
    <Form className='w-100' style={{maxWidth: '34.375rem'}}>
      <Form.Group className="mb-5" controlId="newPassword">
        ...
        <Container className="d-flex gap-3 p-0">
          <div className="w-100">
            <Form.Control type={showPassword ? 'text' : 'password'} placeholder="Enter new password" onBlur={validatePassword1} onChange={updatePasswordValue} className={formValues.password.valid === false && 'is-invalid'} />
          </div>
      ...
      <Form.Group className="mb-40" controlId="newPassword2">
        ...
        <Container className="d-flex gap-3 p-0">
          <div className="w-100">
            <Form.Control type={showPassword2 ? 'text' : 'password'} placeholder="Confirm password" onBlur={validatePassword2} onChange={updatePassword2Value} className={formValues.password2.valid === false && 'is-invalid'} />
          </div>
          <div className="d-flex align-items-center">
