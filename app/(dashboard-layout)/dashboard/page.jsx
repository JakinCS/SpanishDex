    ...
    return (
      <>
        <div className="d-flex justify-content-between align-items-center gap-25 mb-25 mb-sm-60">
          ...
          <ButtonWithIcon isLinkButton={true} href='/dashboard/deck/new' className="btn btn-primary d-none d-md-block" variant='primary' iconSrc='icons/add_3.svg' iconFillColor={'white'} iconHeight={16} altTag="">New Deck</ButtonWithIcon>
        </div>        
