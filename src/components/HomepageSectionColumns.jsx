...
function HomepageSectionColumns({py, backgroundColor, image, imageBorder, imageAlt, imagePosition, headingText, children}) {
    return (
        <Container fluid as='section' className={`px-5 py-${py} bg-${backgroundColor}`}>
            <Row className='gx-40 gy-5 gx-xl-80 gx-xxl-100 justify-content-center'>
                <Col xs={{span: 12, order: 0}} sm='11' md='10' lg={{span: '6', order: imagePosition === 'left' ? 0 : 1}} xl='5'>
